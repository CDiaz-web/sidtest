...
<p class="pagina__descripcion">Elige hasta 5 eventos para asistir de forma presecial.</p>
...
<div class="eventos-registro">
    <main class="eventos-registro__listado">
        ...
        <h3 class="eventos-registro__heading--workshops">&lt;Worhshops/></h3>
        <p class="eventos-registro__fecha">Viernes 5 de Octubre</p>
        ...
        <div class="registro__regalo">
            ...
            <select id="regalo" class="registro__select">
                ...
                <?php foreach($regalos as $regalo){ ;?>
                    <option value="<?php echo $regalo->id;?>" class=""><?php echo $regalo->nombre ;?></option>
                <?php };?>
            </select>
        </div>   
